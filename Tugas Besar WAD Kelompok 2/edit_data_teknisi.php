...
if (isset($_POST['update'])) {
  ...
  // update user data
  $result = mysqli_query($mysqli, "UPDATE data_technisian SET nama='$nama',email='$email',password='$password' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM data_technisian WHERE id=$id");
