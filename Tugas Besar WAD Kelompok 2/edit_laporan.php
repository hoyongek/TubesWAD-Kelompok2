...
if (isset($_POST['update'])) {
  ...
  // update user data
  $result2 = mysqli_query($mysqli, "UPDATE laporan SET nama='$nama',email='$email',laporan='$laporan' WHERE id=$id");
...
$result2 = mysqli_query($mysqli, "SELECT * FROM laporan WHERE id=$id");
