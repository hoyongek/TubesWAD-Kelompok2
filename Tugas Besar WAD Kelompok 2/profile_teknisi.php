                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="profile-img">
                            <img class="rounded profile" src="gambar/<?= $gambar; ?>">
                        </div>
                    </div>
                    <div class=" col-md-2">
                    ...
                    <div class="col-md-5 profile_user_statistik">
                        <div class="p-2 mt-4 bg-primary d-flex justify-content-between rounded text-white stats">
                            <div class="d-flex flex-column"> <span class="tugas_selesai">Tugas Selesai</span>
                                <span class="number1">1100</span>
                            </div>
                            <div class="d-flex flex-column"> <span class="followers">Jumlah Ulasan</span> <span
                                    class="number2">1900</span> </div>
                            <div class="d-flex flex-column"> <span class="rating">Pesanan Di Tolak</span>
                                <span class="number3">10</span>
                            </div>
                        </div>
                        <div class="p-2 mt-4 bg-primary d-flex justify-content-between rounded text-white stats">
                            <div class="d-flex flex-column"> <span class="tugas_selesai">Points Teknisi</span>
                                <span class="number1">1080</span>
                            </div>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="alamat" rows="3"
                                                placeholder="Alamat Anda" required><?= $data['alamat']; ?></textarea>
                                        </div>
