                        ...
                        <div class="card-body">
                            ...
                            <form action="list_teknisi.php" method="GET">
                                ...
                                <button type="submit" value="1" name="submit"
                                    class="btn btn-primary container-fluid">Pesan
                                    Sekarang</button>
                                </p>
                            </form>
                            </p>
                        ...
                        <div class="card-body">
                            ...
                            <form action="list_teknisi.php" method="GET">
                                ...
                                <button type="submit" value="2" name="submit"
                                    class="btn btn-primary container-fluid">Pesan Sekarang</button>
                            </form>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="list_teknisi.php" method="GET">
                                ...
                                <button type="submit" value="3" name="submit"
                                    class="btn btn-primary container-fluid">Pesan Sekarang
                                </button>
                            </form>
                            </p>
                        </div>
